...
import 'package:handwriting/slider/sidebar/menu_item.dart';
...
class _SideBarState extends State<SideBar> with SingleTickerProviderStateMixin<SideBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenHeight = MediaQuery.of(context).size.height -21;
                      ...
                      ListTile(
                        title: Center(
                          child: Text(
                            ...
                            style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.w800, fontFamily: 'Bilbo'),
                          ),
                        ),
                        subtitle: Center(
                          child: Text(
                            "www.datawrangling.io",
                            style: TextStyle(
